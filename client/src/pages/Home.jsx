...
export default function Home() {
  return (
    <div className='px-4 py-12 max-w-2xl mx-auto'>
        ...
        <p  className='mb-4 text-slate-700'>
          Moreover, this app serves as a boilerplate that can be easily integrated into your existing MERN application to provide robust authentication functionality. Whether you're building a new app or enhancing an existing one, this authentication module will streamline the process, allowing you to focus on other critical aspects of your application development.
        </p>
    </div>
  )
}
