  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <button disabled={loading} className='bg-slate-700 rounded-lg uppercase hover:opacity-95 text-white p-3 disabled:opacity-80'>{loading?'Loading...':'Sign Up'}</button>
        <OAuth/>
      </form>
